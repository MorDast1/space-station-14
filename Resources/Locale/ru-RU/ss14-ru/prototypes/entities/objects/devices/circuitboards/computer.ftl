...
ent-CargoRequestEngineeringComputerCircuitboard = консоль инженерных заказов (консольная плата)
    .desc = Консольная плата для консоли заказа Инженер грузов.
ent-CargoRequestMedicalComputerCircuitboard = консоль медицинских заказов (консольная плата)
    .desc = Консольная плата для консоли заказа Мед грузов.
ent-CargoRequestScienceComputerCircuitboard = консоль научных заказов (консольная плата)
    .desc = Консольная плата для консоли заказа РНД грузов.
ent-CargoRequestSecurityComputerCircuitboard = консоль СБ заказов (консольная плата)
    .desc = Консольная плата для консоли заказа СБ грузов.
ent-CargoRequestServiceComputerCircuitboard = консоль сервисных заказов (консольная плата)
    .desc = Консольная плата для консоли заказа Сервис грузов.
ent-FundingAllocationComputerCircuitboard = консоль распределения бюджета (консольная плата)
    .desc = Консольная плата для консоли распределения бюджета.
...
ent-SalvageJobBoardComputerCircuitboard = консоль утилизации (консольная плата)
    .desc = Консольная плата для консоли утилизации.
