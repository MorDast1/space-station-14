...
ent-WeaponTemperatureGun = тепловая винтовка
    .desc = Продвинутая винтовка, которая стреляет лучами, изменяющими температуру. Её использование, вероятно, можно считать военным преступлением.
