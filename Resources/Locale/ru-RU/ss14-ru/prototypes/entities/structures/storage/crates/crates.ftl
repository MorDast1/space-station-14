...
ent-CrateRodentCage = хомячья клетка
    .desc = { ent-CrateGeneric.desc }
ent-CrateBaseLockBox = ящик продаж
    .desc = Защищенный ящик. Выручка с его продажи идет обратно отделу.
ent-CrateLockBoxEngineering = ящик продаж Инж
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = ящик продаж Мед
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = ящик продаж РНД
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = ящик продаж СБ
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = ящик продаж Сервис
    .desc = { ent-CrateBaseLockBox.desc }
