ent-BaseBarrelChem = бочка химикатов
    .desc = Маленький металлический бочонок.
ent-BaseBarrelChemRadioactive = радиоактивная бочка
    .desc = Кажется, она немного протекает. Не думаю, что вам захочется долго находиться рядом.
