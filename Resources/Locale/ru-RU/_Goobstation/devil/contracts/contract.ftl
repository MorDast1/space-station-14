devil-contract-contractee = кредитор
devil-contract-contractor = трактатор
devil-contract-early-sign-failed = Исполнитель должен сначала дождаться подписания контракта!
...
default-contract-content = Это обязательный к исполнению контракт, заключенный в этот день между:
    ...
    - Адской стороной (в дальнейшем "трактатор")
    - Смертной стороной (в дальнейшем "кредитор")
    ...
    { "[" }italic] Все пункты вступают в силу с момента подписания настоящего документа обеими сторонами.{ "[" }/italic]
    { "[" }italic]{ "[" }color=#ac3a0d]Условия не могут быть нарушены. Когда-либо.{ "[" }/color]{ "[" }/italic]
